...
@section('content')
    ...
    <form method="POST"
          action="{{ $editing ? route('manage.locations.update', $location) : route('manage.locations.store') }}"
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('manage.locations.index') }}" class="inline-flex items-center gap-1.5 text-sm font-semibold text-ink-500 transition hover:text-coral">
