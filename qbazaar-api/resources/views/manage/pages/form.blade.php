...
@section('content')
    ...
    <form method="POST"
          action="{{ $isEdit ? route('manage.pages.update', $page) : route('manage.pages.store') }}"
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('manage.pages.index') }}" class="text-sm font-semibold text-ink-500 hover:text-coral">إلغاء</a>
        </div>
    </form>
@endsection
