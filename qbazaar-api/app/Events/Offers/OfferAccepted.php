...
/**
 * Fired after AcceptOfferAction commits.
 *
 * Same channel routing as {@see OfferCreated}:
 *  - `conversation.{conversationId}` — both participants flip the
 *    offer card to its accepted state in real time.
 *  - `user.{otherUserId}` — the buyer (the "other" side from the
 *    seller actor here) gets the badge update outside the open thread.
 */
